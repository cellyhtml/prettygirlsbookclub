...
const books = [
  "O Jogo Elle Kennedy Paralela",
  "A Conquista Elle Kennedy Paralela",
  "Em Rota de Colisão livro alt",
  "Sinais do Amor livro globo",
  "Tempestade de Ônix Planeta Minotauro"
];
